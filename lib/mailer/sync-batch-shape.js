...
import { assignConciergeOwnersForPendingBatch } from './concierge-assign.js';
...
export async function syncMailerBatchToShape(supabase, batchId, { limit = 20, shapeDelayMs = 60 } = {}) {
  ...
  const conciergeCatchUp = await assignConciergeOwnersForPendingBatch(supabase, batchId, {
    limit: safeLimit + 10,
  });
  ...
  return {
    ...
    ...summary,
    concierge_catch_up: conciergeCatchUp,
