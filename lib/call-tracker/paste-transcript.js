import { findTranscriptByExternalCallId, appendTranscript } from '../transcripts.js';
...
export async function pasteCallTranscript(
  ...
  if (!answered?.lead_id) {
    const error = new Error(
      `No call-answered row for call ${normalizedCallId}. The call must hit /api/call-answered first.`,
    );
