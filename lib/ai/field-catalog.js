...
export const SHAPE_FIELD_CATALOG = [
  ...
  { key: 'notes_sidebar', label: 'Sales Notes (Goals & Objectives)', hint: 'LO-facing: 2-4 sentence goals, timeline, next step for Shape notes_sidebar. NOT the full coaching report (that is sales_notes).' },
  { key: 'notes_sidebar_ai_note', label: 'Operations Notes', hint: 'Ops/internal only: manager flags, drip campaign, blockers, compliance. Posted to Shape notes_sidebar_ai_note. NEVER mix with sales notes.' },
