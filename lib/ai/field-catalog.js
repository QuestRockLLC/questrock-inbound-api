...
export const SHAPE_FIELD_CATALOG = [
  ...
  { key: 'notes_sidebar', label: 'Sales Notes (Goals & Objectives)', hint: 'LO-facing: borrower goals, relationship, next sales step, timeline. Posted to Shape notes_sidebar.' },
