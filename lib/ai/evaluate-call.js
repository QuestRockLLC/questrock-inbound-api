...
export async function evaluateCallWithAi({
  ...
  return {
    ...
    questrockAnalysis: {
      ...
      borrower_loan_details: questrockAnalysis.borrower_loan_details ?? {},
    },
